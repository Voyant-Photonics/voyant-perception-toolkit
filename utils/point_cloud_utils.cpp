...
std::vector<double> PointCloudUtils::rngToFreq(const std::vector<double> &rng, double bw, double c, double T)
{
    size_t n = rng.size();
...
double PointCloudUtils::freqToDop(double fd, double lam)
{
    return (lam * fd) / 2;
}
std::pair<std::vector<double>, std::vector<double>> PointCloudUtils::getUpDownFreqs(std::vector<double> &rng,
                                                                                    std::vector<double> &d, double bw,
                                                                                    double c, double T, double lam)
{
...
std::tuple<std::vector<double>, std::vector<double>, std::vector<double>> PointCloudUtils::cart2sphere(
...
std::tuple<std::vector<double>, std::vector<double>, std::vector<double>> PointCloudUtils::sphere2cart(
