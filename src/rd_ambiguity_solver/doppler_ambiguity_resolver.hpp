...
class AmbiguitySolver
{
  public:
    ...
    void writeRecoveredPointsToCSV(const std::string &filename, const std::vector<std::array<double, 12>> &points);
    std::pair<std::vector<double>, std::vector<double>> recoverRangeDoppler(std::vector<double> amb_rng,
